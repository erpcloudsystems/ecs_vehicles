...
def get_conditions(filters):
    ...
    if filters.get("card_code"):
        conditions += " AND license_summary.card_code=%s" % frappe.db.escape(
            filters.get("card_code")
        )
...
def get_query(conditions):
    return frappe.db.sql(
        ...
        {conditions}
        ORDER BY license_summary.from_date DESC, license_no DESC
