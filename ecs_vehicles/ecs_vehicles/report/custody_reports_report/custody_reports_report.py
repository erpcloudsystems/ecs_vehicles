...
def get_item_price_qty_data(filters):
    ...
    if filters.get("fiscal_year"):
        conditions += "and a.fiscal_year = %(fiscal_year)s"
    ...
    item_results = frappe.db.sql("""
        select distinct
            a.name, a.entity_name, a.vehicle_brand, a.vehicle_style, a.vehicle_no, a.ezn_no, a.fiscal_year, a.car_in_date, a.car_out_date
        from
            `tabCustody Report` a
        where
           a.docstatus = 1
