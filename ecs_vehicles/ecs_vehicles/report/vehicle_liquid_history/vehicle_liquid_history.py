...
def get_item_price_qty_data(filters):
    ...
    for item_dict in item_results:
        data = {
            ...
            "plate_no": frappe.db.get_value("Vehicles", filters.get("name"), ["vehicle_no"]) if frappe.db.get_value("Vehicles", filters.get("name"), ["vehicle_no"]) else frappe.db.get_value("Vehicles", filters.get("name"), ["police_id"]),
